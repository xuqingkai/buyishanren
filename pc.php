...
<head>
    ...
    <style type="text/css">
        ...
        header{background:url(./images/header.jpg);margin-bottom:20px;}
        .menu-bg{height:48px;background:#F0EFE2; opacity: 0.8; position: absolute; width:100%;z-index:0}
        nav{position: absolute; width:100%;z-index:10;}
        .logo{padding:5px;font-size:1.5rem;font-weight:bold;margin-right:20px;}
        .logo a{color:#5D6146;}
        .search{padding:80px; text-align:center;}

        .uk-navbar-item, .uk-navbar-nav>li>a, .uk-navbar-toggle{min-height:48px;}
        .uk-navbar-nav>li>a{font-size:16px; color:#5D6146}
        .uk-navbar-nav>li.uk-active>a{border-bottom:3px solid #5D6146;font-weight:bold;color:#5D6146;}

        .uk-subnav{margin-top:0;margin-bottom:0;margin-left:5px;}
        .uk-subnav>*>:first-child{padding:10px;padding-bottom:5px;font-size:15px;color:#333}
        .uk-subnav>*>a{margin-bottom:3px; line-height:32px;}
		.uk-subnav>.uk-active>a{font-weight:bold;margin-bottom:0;border-bottom:3px solid #5D6146;}

        .uk-search{background:#fff; border:2px solid #5D6146;border-radius: 15px; overflow:hidden; width:50%;}
        .sidebar{background:#F0EFE2;border:1px solid #d7d5bc;border-radius:5px;padding-right:15px;width:25%;}
        .sidebar .side-title{margin-left: 20px;border-left:3px solid #A2C241; padding-left:8px;margin-top:15px; font-weight:bold; font-size:18px;}
        .sidebar .side-content a{font-size: 14px;float: left;padding:0 5px;margin-top: 15px;margin-left: 20px;border: 1px solid #DAD9D1;border-radius: 5px;}
        .main{width:75%;margin-right:20px;min-height:500px;}
        .main .uk-card{background:#F0EFE2;border:1px solid #d7d5bc;border-radius:5px;padding:0 15px; margin-bottom:20px;padding:20px;}
        ...
        <nav>
            <div class="uk-container">
                <div class="uk-flex">
                    ...
                    <ul class="uk-navbar-nav" id="category">
        ...
        <div class="uk-flex">
            <div class="main">
                ...
                <div class="uk-card uk-card-body">
                    <h3 class="uk-card-title" id="title<?php echo($article['id']); ?>"><?php echo($article['title']); ?> <a href="">( <?php echo($article['chapter']); ?> )</a></h3>
                    <div class="autor">
                        <img src="./images/author.jpg" />&nbsp;&nbsp;&nbsp;布衣山人 
                    </div>
                    <div class="uk-card-contents" id="contents<?php echo($article['id']); ?>"><?php echo($article['contents']); ?></div>
